...
const TodoForm = ({onSearch, onInputChange, onSubmit, onClear, onClearAll}) => {
    return (
        <form>
            ...
            <input className="todo-input" onChange={onInputChange} type="text" name="todo" placeholder="Add..." autoComplete="off" />
            <br />
